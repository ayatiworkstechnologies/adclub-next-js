...
const bgPencilGray = "/assets/Pencil-left.svg";
const bgPencilYellow = "/assets/Pencil-left.svg";
...
export default function CommunityBanner() {
  ...
  return (
    <section
      className={`relative w-full min-h-screen overflow-hidden flex items-center justify-center text-center px-4 py-16 sm:py-10 md:py-14 lg:py-22 ${
