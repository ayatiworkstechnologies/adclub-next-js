...
import { forgotPasswordReset } from "@/api/api";
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  {...register("password")}
                  className={`w-full text-lg font-glancyr rounded-lg px-5 py-3 pr-12 placeholder-gray-600 focus:outline-none focus:ring-2 ${
                    errors.password
