    ...
    >
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        <motion.main className="md:col-span-2 space-y-10" variants={fadeUp}>
          ...
          >
            With over{" "}
            <strong className="text-primary">1,000+ dynamic voices </strong> and
          ...
          >
            ...
            marketing professionals, students, and visionaries converge to shape
          ...
          <motion.div variants={fadeUp}>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-gray-300">
              ...
              <li>
                <strong className="text-white">Learn &amp; Lead:</strong> Level
                up your skills through workshops, seminars, and masterclasses
                led by industry leaders who&apos;ve been there, done that.
              </li>
              <li>
                <strong className="text-white">Gain Exposure:</strong> Access to
                top speakers and thought leaders from advertising, media,
                communications, PR, and beyond.
              </li>
              <li>
                <strong className="text-white">Exclusive Access:</strong> Enjoy
                free or discounted entry to Ad Club events, seminars, and
          ...
          <motion.p
            ...
            variants={fadeUp}
          >
            Membership isn&apos;t just about access, it&apos;s about belonging.
            It&apos;s about securing your place in Chennai&apos;s advertising
            story, joining a dynamic community of creative professionals, and
            positioning yourself at the heart of innovation, collaboration, and
            recognition.
          </motion.p>
          ...
          <motion.div variants={fadeUp}>
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm sm:text-base text-gray-300">
              <li>Corporate Membership: ₹6,000 + 18% GST = ₹7,080</li>

              <li>Individual Membership: ₹2,500 + 18% GST = ₹2,950</li>

              <li>Student Membership: ₹1,000 + 18% GST = ₹1,180</li>
            </ul>
          </motion.div>
          ...
          >
            ...
            the community that defines what&apos;s next in the advertising
            industry of India.
          </motion.p>
        </motion.main>
      </div>
