  ...
  useEffect(() => {
    async function fetchMembershipDetails() {
      try {
        ...
        const res = await getMembershipDetails({ id: userId });
          ...
          <div className="space-y-6 text-sm text-gray-300">
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-600 space-y-4">
              <p>
                ...
                {fees.CORPORATE.base > 0 ? Math.round((fees.CORPORATE.gst / fees.CORPORATE.base) * 100) : 18}%
                (CGST 9%, SGST 9%) ={" "}
              ...
              <p>
                ...
                {fees.INDIVIDUAL.base > 0 ? Math.round((fees.INDIVIDUAL.gst / fees.INDIVIDUAL.base) * 100) : 18}%
                (CGST 9%, SGST 9%) ={" "}
                <strong className="text-primary">
              ...
              <p>
                ...
                {fees.STUDENT.base > 0 ? Math.round((fees.STUDENT.gst / fees.STUDENT.base) * 100) : 18}%
                (CGST 9%, SGST 9%) ={" "}
                <strong className="text-primary">
